...
<!-- Schematron modified by NIST, April 2016 -->
...
Note: Form Element: Date and time of observation unit discharge</sch:assert>
  ...
  <sch:pattern id="p-urn-oid-2.16.840.1.113883.10.20.34.3.32-errors">
    <sch:rule id="r-urn-oid-2.16.840.1.113883.10.20.34.3.32-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-1106-851" test="cda:code[@code='78030-4']">This code SHALL contain exactly one [1..1] @code="78030-4" ED Episode of Care (CONF:1106-851). NOTE: THIS LOINC CODE WAS CORRECTED IN ERRATA.</sch:assert>
    </sch:rule>
...
SHALL contain exactly one [1..1] value with @xsi:type="BL" (CONF:1106-X).</sch:assert>
  ...
  <sch:pattern id="p-version-issues-warnings">
